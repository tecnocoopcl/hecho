...
import { Button, Input, CategorySelect, colorForCategoria } from './ui';
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%", marginBottom: "0.5rem" }}>
          ...
          <div style={{ display: "flex", gap: "0.25rem" }}>
            <Button
              ...
              title="Estadísticas"
              icon
              style={{ color: vista === "estadisticas" ? "#4fc3f7" : undefined }}
            >
        ...
        {showCats && (
          <div style={{ width: "100%", background: "#3a3f4b", borderRadius: "8px", padding: "1rem", marginBottom: "1rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.75rem" }}>
              ...
              <Button kind="minimal" size="mini" icon onClick={() => setShowCats(false)}>
                ...
                <li key={c.id} style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.4rem" }}>
                  ...
                  {editCatId === c.id ? (
                    ...
                    <>
                      ...
                      <Button kind="minimal" size="mini" icon onClick={() => iniciarEditCat(c)}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 1 1 3 3L7 19l-4 1 1-4 12.5-12.5z" />
                        </svg>
                      </Button>
                      <Button kind="minimal" size="mini" icon danger onClick={() => eliminarCategoria(c.id)}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        return (
                          <li key={r.id} style={itemStyle}>
                            ...
                            <div style={{ display: "flex" }}>
                              <Button onClick={() => editar(r)} kind="tertiary" icon>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                  <path d="M12 20h9" />
                                  <path d="M16.5 3.5a2.121 2.121 0 1 1 3 3L7 19l-4 1 1-4 12.5-12.5z" />
                                </svg>
                              </Button>
                              <Button onClick={() => eliminar(r.id)} kind="tertiary" icon danger>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
